...
export default class NavMenu extends React.PureComponent<{}, { isOpen: boolean }> {
    ...
    public render() {
        return (
            <header>
                <Navbar className="navbar-expand-sm navbar-toggleable-sm border-bottom box-shadow mb-3 navbar-dark bg-dark" dark>
                    <Container>
                        ...
                        <Collapse className="d-sm-inline-flex flex-sm-row-reverse" isOpen={this.state.isOpen} navbar>
                            <ul className="navbar-nav flex-grow">
                                ...
                                <NavItem>
                                    <NavLink className="text-light" href="swagger/index.html">Swagger</NavLink>
                                </NavItem>
                            </ul>
                        </Collapse>
                    </Container>
