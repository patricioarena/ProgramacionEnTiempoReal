...
namespace AWSServerless.Controllers
{
    ...
    public class PresignedUrlController : ControllerBase
    {
        ...
        public PresignedUrlController(IOptions<Options> options)
        {
            _options = new Options
            {
                AWS_SPEECH_REGION = options.Value.AWS_SPEECH_REGION,
                AWS_SPEECH_ACCESS_KEY = options.Value.AWS_SPEECH_ACCESS_KEY,
                AWS_SPEECH_SECRET_KEY = options.Value.AWS_SPEECH_SECRET_KEY
            };
