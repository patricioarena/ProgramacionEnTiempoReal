...
namespace Application.Services
{
    public class PresignedUrlService : IPresignedUrlService
    {
        ...
        {
            _region = Environment.GetEnvironmentVariable("speechRegion");
            _awsAccessKey = Environment.GetEnvironmentVariable("speechAcessKey");
            _awsSecretKey = Environment.GetEnvironmentVariable("speechSecretKey");
        }
